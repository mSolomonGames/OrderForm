        ...
        <React.Fragment >
            <Paper>            
                <Grid container spacing={0} justify="center">
                    <Grid item xs={12}>
                        <Typography align="center" color="textSecondary" variant="h4">Terms and Conditions</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container justify="center">
                            <Grid item xs ={10}>
                            <Typography color="textSecondary" align="center" variant="body1">All Fibre and accounts are area specific, might not be available in all areas. Please note: It is the Clients'
                            ...
                            <Grid item xs ={10}>
                            <Typography color="textSecondary" align="center" variant="body1">Please note that cancellations received after the 3rd of the month will only be processed in the following
                    ...
                    <Grid item xs={4}>
                        ...
                        <FormControlLabel align="center"
                            ...
                            label={<Typography color="textSecondary" align="center" variant="body1">I accept the Terms & Conditions</Typography>}
                        />
                    </Grid>
